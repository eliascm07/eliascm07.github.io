...
**Implementation of Autonomy Algorithms for the Maintenance of Flat Pavement Markings Using a Mobile Robot** — Bachelor's Thesis {% cite cabeza2025pavementmarking %} (Trabajo de Investigación) in Mechatronics Engineering, UTEC.
...
<div class="max-w-2xl mx-auto my-4">
    {% include figure.liquid path="assets/img/3_pavement_marking_robot/robot_platform.jpg" title="Mobile robot platform for pavement marking maintenance" class="w-full h-auto rounded-lg shadow-md" %}
</div>
<div class="caption">
...
<div class="max-w-2xl mx-auto my-4">
    {% include figure.liquid path="assets/img/3_pavement_marking_robot/stage1_recognition_mapping.jpg" title="Etapa 1: Reconocimiento y mapeo" class="w-full h-auto rounded-lg shadow-md" %}
</div>
<div class="caption">
...
<div class="max-w-2xl mx-auto my-4">
    {% include figure.liquid path="assets/img/3_pavement_marking_robot/stage2_processing_interest_zones.jpg" title="Etapa 2: Procesamiento y cálculo de zonas de interés" class="w-full h-auto rounded-lg shadow-md" %}
</div>
<div class="caption">
...
<div class="max-w-2xl mx-auto my-4">
    {% include figure.liquid path="assets/img/3_pavement_marking_robot/stage3_trajectory_planning.jpg" title="Etapa 3: Planificación y ejecución de trayectoria" class="w-full h-auto rounded-lg shadow-md" %}
</div>
<div class="caption">
...
<div class="flex flex-wrap justify-center gap-3 my-4">
    <a href="assets/pdf/3_pavement_marking_robot/tesis_mantenimiento_marcas_viales.pdf" target="_blank" class="inline-flex items-center gap-2 border border-divider text-text text-sm rounded-full px-4 py-2 hover:bg-divider/20 transition-colors">
        <i class="fa-solid fa-file-pdf"></i> Download Full Thesis (PDF, Spanish)
    </a>
    <a href="assets/pdf/3_pavement_marking_robot/presentacion_sustentacion.pptx" target="_blank" class="inline-flex items-center gap-2 border border-divider text-text text-sm rounded-full px-4 py-2 hover:bg-divider/20 transition-colors">
        <i class="fa-solid fa-file-powerpoint"></i> Download Presentation (PPTX, Spanish)
    </a>
